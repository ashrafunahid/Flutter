import 'package:budget_app/helpers/color_helpers.dart';
          ...
          children: <Widget>[
            Container(
              ...
              child: CustomPaint(
                ...
                child: Center(
                  child: Text('\$${amountLeft.toStringAsFixed(2)} / \$${widget.category.maxAmount}', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w600),),
                ),
              ),
            ),
            _buildExpenses(),
